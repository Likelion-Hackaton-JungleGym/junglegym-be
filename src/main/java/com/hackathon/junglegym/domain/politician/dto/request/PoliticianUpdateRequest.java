...
@AllArgsConstructor
@NoArgsConstructor
@Schema(title = "PoliticianUpdateRequest DTO", description = "정치인 정보 수정을 위한 데이터 전송")
public class PoliticianUpdateRequest {
  ...
  @Schema(
      description = "역할",
      example = "NATIONAL_ASSEMBLY(국회의원)",
      allowableValues = {"NATIONAL_ASSEMBLY", "MAYOR_PROVINCIAL", "MAYOR_MUNICIPAL"})
  private Role role;
