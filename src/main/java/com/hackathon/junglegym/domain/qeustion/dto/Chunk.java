...
@AllArgsConstructor
@NoArgsConstructor
@Schema(title = "Chunk DTO", description = "청킹된 텍스트 조각(임베딩/업서트 단위)")
public class Chunk {
  ...
  @Schema(description = "청크 텍스트", example = "이 법은 대한민국헌법과 ~~...")
  private String text;

  @Schema(description = "청크 인덱스(같은 조문 내 순서)", example = "0")
  private Integer chunkIndex;

  @Schema(description = "토큰 수(없으면 0)", example = "128")
